// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for null.
...
// You can continue to use the null provider in your CDK for Terraform projects with newer versions of CDKTF,
