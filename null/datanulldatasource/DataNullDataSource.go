...
import (
	...
	_init_ "github.com/cdktn-io/cdktn-provider-null-go/null/v15/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/cdktn-io/cdktn-provider-null-go/null/v15/datanulldatasource/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/null/3.3.1/docs/data-sources/data_source null_data_source}.
...
func (j *jsiiProxy_DataNullDataSource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataNullDataSource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataNullDataSource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataNullDataSource) Outputs() cdktn.StringMap {
...
func (j *jsiiProxy_DataNullDataSource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataNullDataSource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/null/3.3.1/docs/data-sources/data_source null_data_source} Data Source.
...
func (j *jsiiProxy_DataNullDataSource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataNullDataSource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataNullDataSource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataNullDataSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataNullDataSource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataNullDataSource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataNullDataSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataNullDataSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
